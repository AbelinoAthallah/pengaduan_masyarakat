...
<section class="main-section">
    <div class="content">
        <h1 align="center">Tambah Petugas</h1>
        <hr>
        ...
        <form action="{{ url('/petugas/store_2') }}" method="post">
        {{ csrf_field() }}
		...
		<br>
            ...
            <div class="form-group">
                ...
                <a href="{{url('/data_petugas')}}" class="btn btn-danger"><i class="fa fa-arrow-left"></i><b> Cancel</b></a>
            </div>
        </form>
