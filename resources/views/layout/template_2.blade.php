      ...
      <header class="header black-bg">
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="{{url('/logout_masyarakat')}}">Logout</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu"  >
                      ...
                      <ul class="sub">
                          <li><a  href="/pengaduan_masyarakat/public/pengaduan_create">Ajukan Pengaduan</a></li>
                          <li><a  href="/pengaduan_masyarakat/public/pengaduan_masyarakat">Data Pengaduan</a></li>
                          <li><a  href="/pengaduan_masyarakat/public/tanggapan_masyarakat">Data Tanggapan</a></li>
                      </ul>
                  </li>
