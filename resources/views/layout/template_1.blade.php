      ...
      <header class="header black-bg">
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="{{url('/logout_petugas')}}">Logout</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><img src="assets/img/laporan.jpg" class="img-circle" width="60"></p>
              	  <h5 class="centered">PENGADUAN MASYARAKAT</h5>
                  ...
                  <li class="sub-menu"  >
                      ...
                      <ul class="sub">
                          <li><a  href="/pengaduan_masyarakat/public/pengaduan_admin">Data Pengaduan</a></li>
                      </ul>
                      <ul class="sub">
                          <li><a  href="/pengaduan_masyarakat/public/tanggapan_admin">Cetak Laporan</a></li>
                      </ul>
                  </li>
                  ...
                  <li class="sub-menu"  >
                      ...
                      <ul class="sub">
                          <li><a  href="/pengaduan_masyarakat/public/data_petugas">Petugas</a></li>
                          <li><a  href="/pengaduan_masyarakat/public/data_masyarakat">Masyarakat</a></li>
                      </ul>
                  </li>
                  @endif
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <!-- <li><a  href="/sembako_laravel/public/barang_pembeli">Barang</a></li> -->
                          <li><a  href="/pengaduan_masyarakat/public/pengaduan_admin">Data Pengaduan</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu"  >
